...
function install_pgadmin() {
    ...
    sudo sh -c 'echo "deb [signed-by=/usr/share/keyrings/packages-pgadmin-org.gpg] https://ftp.postgresql.org/pub/pgadmin/pgadmin4/apt/$(lsb_release -cs)/dists/pgadmin4/main" > /etc/apt/sources.list.d/pgadmin4.list && apt update'
